...
export const threadListCommand = '20011'
export const threadDetailCommand = '20012'

export const COMMAND_PROTO = [
  { type: '2', command: '20010', result: 'Overview', description: 'instance overview' },
  { type: '2', command: threadListCommand, param: 'ThreadListParam', result: 'ThreadList', description: 'thread base info list' },
  { type: '2', command: threadDetailCommand, param: 'ThreadDetailParam', result: 'ThreadDetail', description: 'thread detail info' },
