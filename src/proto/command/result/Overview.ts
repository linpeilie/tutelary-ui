...
function createBaseOverview(): Overview {
  return {
    hostInfo: undefined,
    threadStatistic: {} as ThreadStatistic,
    threads: [],
    heapMemory: [],
    nonHeapMemory: [],
    garbageCollectors: [],
