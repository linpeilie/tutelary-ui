...
| `POST /api/command/creation/traceTaskList` | `200037` | `NoneParamRequest` | 无 | `200037 -> EnhanceTaskListResponse`（所有增强任务的进行中+最近完成记录） |
| `POST /api/command/creation/cancelTask` | — | `instanceId`, `taskId` (query params) | — | 取消正在执行的命令任务 |
